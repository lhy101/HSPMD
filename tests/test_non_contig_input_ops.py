...
class TestAbsOps(unittest.TestCase):
    ...
    def test_abs_op(self):
        ...
        for shape in TestAbsOps._test_shapes:
            ...
            self.assertTrue(allclose(hspmd.abs(trans_x), gt))
        print(sys._getframe().f_code.co_name)
...
class TestNegOps(unittest.TestCase):
    ...
    def test_neg_op(self):
        ...
        for shape in TestNegOps._test_shapes:
            ...
            self.assertTrue(allclose(hspmd.neg(trans_x), gt))
            ...
            if GRAD_TEST:
                ...
                trans_hspmd_in = hspmd_in.transpose(perm)
                hspmd_out = hspmd.neg(trans_hspmd_in)
...
class TestReciprocalOps(unittest.TestCase):
    ...
    def test_reciprocal_op(self):
        ...
        for shape in TestReciprocalOps._test_shapes:
            ...
            self.assertTrue(allclose(hspmd.reciprocal(trans_x), gt))
            ...
            if GRAD_TEST:
                ...
                hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
                trans_hspmd_in = hspmd_in.transpose(perm)
                hspmd_out = hspmd.reciprocal(trans_hspmd_in)
                hspmd_loss = hspmd_out.sum()
                hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.5)
                torch_loss.backward()
                torch_optimizer.step()
...
class TestArithmeticOps(unittest.TestCase):
    ...
    def test_elementwise_add(self):
        ...
        for shape in TestArithmeticOps._test_elementwise_shapes:
            ...
            self.assertTrue(allclose(hspmd.add(trans_x, trans_y), gt))
            ...
            self.assertTrue(allclose(hspmd.add(trans_x, c), gt))
            self.assertTrue(allclose(hspmd.add(c, trans_x), gt))
        print(sys._getframe().f_code.co_name)
    ...
    def test_broadcast_add(self):
        ...
        for shape_x, shape_y in TestArithmeticOps._test_broadcast_shapes:
            ...
            if GRAD_TEST:
              ...
              trans_hspmd_in = hspmd_in.transpose(perm_y)
              hspmd_out = hspmd.add(trans_hspmd_in, trans_x)
              hspmd_loss = hspmd_out.sum()
              hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.5)
              torch_loss.backward()
              torch_optimizer.step()
    ...
    def test_sqrt(self):
        ...
        for shape in TestArithmeticOps._test_elementwise_shapes:
            ...
            self.assertTrue(allclose(hspmd.sqrt(trans_x), gt))
            ...
            if GRAD_TEST:
                ...
                hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
                trans_hspmd_in = hspmd_in.transpose(perm)
                hspmd_out = hspmd.sqrt(trans_hspmd_in)
                hspmd_loss = hspmd_out.sum()
                hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.5)
                torch_loss.backward()
                torch_optimizer.step()
    ...
    def test_rsqrt(self):
        ...
        for shape in TestArithmeticOps._test_elementwise_shapes:
            ...
            self.assertTrue(allclose(hspmd.rsqrt(trans_x), gt))
            ...
            if GRAD_TEST:
                ...
                hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
                trans_hspmd_in = hspmd_in.transpose(perm)
                hspmd_out = hspmd.rsqrt(trans_hspmd_in)
                hspmd_loss = hspmd_out.sum()
                hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.5)
                torch_loss.backward()
                torch_optimizer.step()
    ...
    def test_pow(self):
        ...
        for shape in TestArithmeticOps._test_elementwise_shapes:
            ...
            for exponent in TestArithmeticOps._test_pow_exponents:
                ...
                self.assertTrue(allclose(hspmd.pow(trans_x, exponent), gt))
                ...
                if GRAD_TEST:
                    ...
                    hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
                    trans_hspmd_in = hspmd_in.transpose(perm)
                    hspmd_out = hspmd.pow(trans_hspmd_in, exponent)
                    hspmd_loss = hspmd_out.sum()
                    hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.5)
                    torch_loss.backward()
                    torch_optimizer.step()
    ...
    def test_ceil(self):
        ...
        for shape in TestArithmeticOps._test_elementwise_shapes:
            ...
            self.assertTrue(allclose(hspmd.ceil(trans_x), gt))
            ...
            if GRAD_TEST:
                ...
                hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
                trans_hspmd_in = hspmd_in.transpose(perm)
                hspmd_out = hspmd.ceil(trans_hspmd_in)
                hspmd_loss = hspmd_out.sum()
                hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.5)
                torch_loss.backward()
                torch_optimizer.step()
    ...
    def test_floor(self):
        ...
        for shape in TestArithmeticOps._test_elementwise_shapes:
            ...
            self.assertTrue(allclose(hspmd.floor(trans_x), gt))
            ...
            if GRAD_TEST:
                ...
                hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
                trans_hspmd_in = hspmd_in.transpose(perm)
                hspmd_out = hspmd.floor(trans_hspmd_in)
                hspmd_loss = hspmd_out.sum()
                hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.5)
                torch_loss.backward()
                torch_optimizer.step()
    ...
    def test_round(self):
        ...
        for shape in TestArithmeticOps._test_elementwise_shapes:
            ...
            self.assertTrue(allclose(hspmd.round(trans_x), gt))
            ...
            if GRAD_TEST:
                ...
                hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
                trans_hspmd_in = hspmd_in.transpose(perm)
                hspmd_out = hspmd.round(trans_hspmd_in)
                hspmd_loss = hspmd_out.sum()
                hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.5)
                torch_loss.backward()
                torch_optimizer.step()
...
class TestDotOps(unittest.TestCase):
    ...
    def test_dot_op(self):
        ...
        for shape_x, strided_shape, strided_stride in TestDotOps._test_shapes:
            ...
            x = hspmd.from_numpy(x_np)
            y = hspmd.from_numpy(y_np)
            strided_hspmd_x = hspmd.as_strided(x, list(strided_shape), list(strided_stride), 0)
            strided_hspmd_y = hspmd.as_strided(y, list(strided_shape), list(strided_stride), 0)
            ...
            self.assertTrue(allclose(hspmd.matmul(strided_hspmd_x, strided_hspmd_y), gt))
            self.assertTrue(allclose(strided_hspmd_x.matmul(strided_hspmd_y), gt))
            ...
            if GRAD_TEST:
              ...
              torch_optimizer = optim.SGD([torch_in], lr = 0.5)
              hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
              strided_hspmd_in = hspmd.as_strided(hspmd_in, list(strided_shape), list(strided_stride), 0)
              hspmd_out = hspmd.matmul(strided_hspmd_in, strided_hspmd_y)
              hspmd_loss = hspmd_out.sum()
              hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.5)
              torch_loss.backward()
              torch_optimizer.step()
...
class TestMatMulOps(unittest.TestCase):
    ...
    def test_matmul_op(self):
        ...
        for shape_x, shape_y in TestMatMulOps._matmul_shapes:
            ...
            self.assertTrue(allclose(hspmd.matmul(trans_x, trans_y), gt))
            ...
            if GRAD_TEST:
              ...
              torch_optimizer = optim.SGD([torch_in], lr = 0.5)
              hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
              trans_hspmd_in = hspmd_in.transpose(perm_x)
              hspmd_out = hspmd.matmul(trans_hspmd_in, trans_y)
              hspmd_loss = hspmd_out.sum()
              hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.5)
              torch_loss.backward()
              torch_optimizer.step()
    ...
    def test_linear_op(self):
        ...
        for shape_x, shape_y in TestMatMulOps._linear_shapes:
            ...
            self.assertTrue(allclose(hspmd.linear(trans_x, trans_w, bias), gt))
            ...
            if GRAD_TEST:
              ...
              hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
              trans_hspmd_in = hspmd_in.transpose(perm_x)
              hspmd_out = hspmd.linear(trans_hspmd_in, trans_w, bias)
              hspmd_loss = hspmd_out.sum()
              hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.5)
              torch_loss.backward()
              torch_optimizer.step()
...
class TestBatchMatMulOps(unittest.TestCase):
    ...
    def test_batch_matmul_op(self):
        ...
        for shape_x, shape_y in TestBatchMatMulOps._test_shapes:
            ...
            self.assertTrue(allclose(hspmd.bmm(trans_x, trans_y), gt))
            ...
            if GRAD_TEST:
              ...
              hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
              trans_hspmd_in = hspmd_in.transpose(perm_x)
              hspmd_out = hspmd.bmm(trans_hspmd_in, trans_y)
              hspmd_loss = hspmd_out.sum()
              hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.5)
              torch_loss.backward()
              torch_optimizer.step()
...
class TestActivationOps(unittest.TestCase):
    ...
    def test_sigmoid_op(self):
        ...
        for shape in TestActivationOps._test_shapes:
            ...
            self.assertTrue(allclose(hspmd.sigmoid(trans_x), gt))
            ...
            if GRAD_TEST:
              ...
              hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
              trans_hspmd_in = hspmd_in.transpose(perm)
              hspmd_out = hspmd.sigmoid(trans_hspmd_in)
              hspmd_loss = hspmd_out.sum()
              hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.01)
              torch_loss.backward()
              torch_optimizer.step()
              hspmd_optimizer.minimize(hspmd_loss).get_or_compute()
              self.assertTrue(allclose(hspmd_in, torch_in.detach().numpy()))
        print(sys._getframe().f_code.co_name)
    ...
    def test_sin_op(self):
        ...
        for shape in TestActivationOps._test_shapes:
            ...
            self.assertTrue(allclose(hspmd.sin(trans_x), gt))
            ...
            if GRAD_TEST:
              ...
              hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
              trans_hspmd_in = hspmd_in.transpose(perm)
              hspmd_out = hspmd.sin(trans_hspmd_in)
              hspmd_loss = hspmd_out.sum()
              hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.01)
              torch_loss.backward()
              torch_optimizer.step()
    ...
    def test_relu_op(self):
        ...
        for shape in TestActivationOps._test_shapes:
            ...
            self.assertTrue(allclose(hspmd.relu(trans_x), gt))
            ...
            if GRAD_TEST:
              ...
              hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
              trans_hspmd_in = hspmd_in.transpose(perm)
              hspmd_out = hspmd.relu(trans_hspmd_in)
              hspmd_loss = hspmd_out.sum()
              hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.01)
              torch_loss.backward()
              torch_optimizer.step()
    ...
    def test_leaky_relu_op(self):
        ...
        for shape in TestActivationOps._test_shapes:
            ...
            for alpha in alphas:
                ...
                self.assertTrue(allclose(hspmd.leakyrelu(trans_x, alpha), gt))
                ...
                if GRAD_TEST:
                    ...
                    hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
                    trans_hspmd_in = hspmd_in.transpose(perm)
                    hspmd_out = hspmd.leakyrelu(trans_hspmd_in, alpha)
                    hspmd_loss = hspmd_out.sum()
                    hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.01)
                    torch_loss.backward()
                    torch_optimizer.step()
    ...
    def test_tanh_op(self):
        ...
        for shape in TestActivationOps._test_shapes:
            ...
            self.assertTrue(allclose(hspmd.tanh(trans_x), gt))
            ...
            if GRAD_TEST:
              ...
              hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
              trans_hspmd_in = hspmd_in.transpose(perm)
              hspmd_out = hspmd.tanh(trans_hspmd_in)
              hspmd_loss = hspmd_out.sum()
              hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.01)
              torch_loss.backward()
              torch_optimizer.step()
    ...
    def test_triu_op(self):
        ...
        for shape in TestActivationOps._test_shapes:
            ...
            self.assertTrue(allclose(hspmd.triu(trans_x, False, 0), gt))
            ...
            if GRAD_TEST:
              ...
              hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
              trans_hspmd_in = hspmd_in.transpose(perm)
              hspmd_out = hspmd.triu(trans_hspmd_in, False, 0)
              hspmd_loss = hspmd_out.sum()
              hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.01)
              torch_loss.backward()
              torch_optimizer.step()
    ...
    def test_tril_op(self):
        ...
        for shape in TestActivationOps._test_shapes:
            ...
            self.assertTrue(allclose(hspmd.triu(trans_x, True, 0), gt))
            ...
            if GRAD_TEST:
              ...
              hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
              trans_hspmd_in = hspmd_in.transpose(perm)
              hspmd_out = hspmd.triu(trans_hspmd_in, True, 0)
              hspmd_loss = hspmd_out.sum()
              hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.01)
              torch_loss.backward()
              torch_optimizer.step()
    ...
    def test_softmax_op(self):
        ...
        for shape, dim in TestActivationOps._test_softmax_shapes:
            ...
            self.assertTrue(allclose(hspmd.softmax(trans_x, dim), gt))
            ...
            if GRAD_TEST:
              ...
              hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
              trans_hspmd_in = hspmd_in.transpose(perm)
              hspmd_out = hspmd.softmax(trans_hspmd_in, 0)
              hspmd_loss = hspmd_out.sum()
              hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.01)
              torch_loss.backward()
              torch_optimizer.step()
...
class TestTransformOps(unittest.TestCase):
    ...
    def test_reshape_op(self):
        ...
        for shape in TestTransformOps._test_shapes:
            ...
            self.assertTrue(allclose(hspmd.reshape(trans_x, shape_to), gt))
            ...
            if GRAD_TEST:
              ...
              hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
              trans_hspmd_in = hspmd_in.transpose(perm)
              hspmd_out = hspmd.reshape(trans_hspmd_in, shape_to)
              hspmd_loss = hspmd_out.sum()
              hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.5)
              torch_loss.backward()
              torch_optimizer.step()
    ...
    def test_broadcast_op(self):
        ...
        for shape in TestTransformOps._test_shapes:
            ...
            self.assertTrue(allclose(hspmd.broadcast(trans_x, shape_to, []), gt))
            ...
            if GRAD_TEST:
              ...
              hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
              trans_hspmd_in = hspmd_in.transpose(perm)
              hspmd_out = hspmd.broadcast(trans_hspmd_in, shape_to, [])
              hspmd_loss = hspmd_out.sum()
              hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.01)
              torch_loss.backward()
              torch_optimizer.step()
    ...
    def test_concat_op(self):
        ...
        for shape in TestTransformOps._test_shapes:
            ...
            self.assertTrue(allclose(hspmd.concat(trans_x, trans_y, 0), gt))
            self.assertTrue(allclose(trans_x.concat(trans_y, 0), gt))
            self.assertTrue(allclose(hspmd.concat([trans_x, trans_y], 0), gt))
            gt = np.concatenate((trans_x_np, trans_y_np, trans_z_np), 0)
            self.assertTrue(allclose(hspmd.concat([trans_x, trans_y, trans_z], 0), gt))
        print(sys._getframe().f_code.co_name)
    ...
    def test_pad_op(self):
        ...
        for shape in TestTransformOps._pad_shapes:
            ...
            self.assertTrue(allclose(hspmd.pad(trans_x, [1,1,2,2], "constant", 0.1), gt))
            ...
            if GRAD_TEST:
              ...
              hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
              trans_hspmd_in = hspmd_in.transpose(perm)
              hspmd_out = hspmd.pad(trans_hspmd_in, [1,1,2,2], "constant", 0.1)
              hspmd_loss = hspmd_out.sum()
              hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.01)
              torch_loss.backward()
              torch_optimizer.step()
...
class TestNormOps(unittest.TestCase):
    ...
    def test_layernorm_op(self):
        ...
        for shape in TestNormOps._test_shapes:
            ...
            for i in range(1, 4):
                ...
                self.assertTrue(allclose(hspmd.layer_norm(trans_x, scale, bias, list(norm_shape), 1e-5)[0], gt))
                ...
                if GRAD_TEST:
                    ...
                    hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
                    trans_hspmd_in = hspmd_in.transpose(perm)
                    hspmd_out = hspmd.layer_norm(trans_hspmd_in, scale, bias, list(norm_shape), 1e-5)[0]
                    hspmd_loss = hspmd_out.sum()
                    hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.01)
                    torch_loss.backward()
                    torch_optimizer.step()
    ...
    def test_instancenorm_op(self):
        ...
        for shape in TestNormOps._test_shapes:
            ...
            self.assertTrue(allclose(hspmd.instance_norm(trans_x, 1e-5)[0], gt))
            ...
            if GRAD_TEST:
                ...
                hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
                trans_hspmd_in = hspmd_in.transpose(perm)
                hspmd_out = hspmd.instance_norm(trans_hspmd_in, 1e-5)[0]
                hspmd_loss = hspmd_out.sum()
                hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.01)
                torch_loss.backward()
                torch_optimizer.step()
...
class TestReduceOps(unittest.TestCase):
    ...
    def test_reduce_sum_op(self):
        ...
        for shape_x in TestReduceOps._test_shapes:
            ...
            self.assertTrue(allclose(hspmd.reduce(trans_x, "sum"), gt))
            self.assertTrue(allclose(trans_x.reduce("sum"), gt))
            self.assertTrue(allclose(hspmd.sum(trans_x), gt))
            ...
            for i in range(1, pow(2, len(shape_x))):
                ...
                self.assertTrue(allclose(hspmd.sum(trans_x, axes), gt.cpu().numpy()))
                self.assertTrue(allclose(trans_x.sum(axes), gt.cpu().numpy()))
                # keepdim test
                gt = torch.sum(torch_x, axes, keepdims=True)
                self.assertTrue(allclose(hspmd.sum(trans_x, axes, [True]), gt.cpu().numpy()))
        print(sys._getframe().f_code.co_name)
    ...
    def test_reduce_mean_op(self):
        ...
        for shape_x in TestReduceOps._test_shapes:
            ...
            self.assertTrue(allclose(hspmd.reduce(trans_x, "mean"), gt))
            self.assertTrue(allclose(trans_x.reduce("mean"), gt))
            self.assertTrue(allclose(hspmd.mean(trans_x), gt))
            ...
            for i in range(1, pow(2, len(shape_x))):
                ...
                self.assertTrue(allclose(hspmd.mean(trans_x, axes), gt.cpu().numpy()))
                self.assertTrue(allclose(trans_x.mean(axes), gt.cpu().numpy()))
                # keepdim test
                gt = torch.mean(torch_x, axes, keepdims=True)
                self.assertTrue(allclose(hspmd.mean(trans_x, axes, [True]), gt.cpu().numpy()))
        print(sys._getframe().f_code.co_name)
...
class TestLossOps(unittest.TestCase):
    ...
    def test_bce_op(self):
        ...
        for shape in TestLossOps._test_binary_label_shapes:
            ...
            loss = hspmd.binary_cross_entropy(trans_probs, trans_labels)
            ...
            if GRAD_TEST:
                ...
                trans_hspmd_in = hspmd_in.transpose(perm)
                hspmd_out = hspmd.binary_cross_entropy(trans_hspmd_in, hspmd.from_numpy(trans_labels_np))
                hspmd_loss = hspmd_out.sum()
                hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.01)
                torch_loss.backward()
                torch_optimizer.step()
                hspmd_optimizer.minimize(hspmd_loss).get_or_compute()
                self.assertTrue(allclose(hspmd_in, torch_probs.detach().numpy()))
        print(sys._getframe().f_code.co_name)
    ...
    def test_nllloss_op(self):
        ...
        for shape, lshape in TestLossOps._test_nllloss_label_shapes:
            ...
            loss = hspmd.nll_loss(trans_probs, labels)
            self.assertTrue(allclose(loss, gt))
            ...
            if GRAD_TEST:
                ...
                hspmd_in = hspmd.Tensor(probs_np, requires_grad=True)
                trans_hspmd_in = hspmd_in.transpose(perm)
                hspmd_out = hspmd.nll_loss(trans_hspmd_in, labels)
                hspmd_loss = hspmd_out.sum()
                hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.5)
                torch_loss.backward()
                torch_optimizer.step()
    ...
    def test_kldivloss_op(self):
        ...
        for shape in TestLossOps._test_binary_label_shapes:
            ...
            loss = hspmd.kl_div(trans_probs, trans_labels)
            self.assertTrue(allclose(loss, gt))
            ...
            if GRAD_TEST:
                ...
                hspmd_in = hspmd.Tensor(probs_np, requires_grad=True)
                trans_hspmd_in = hspmd_in.transpose(perm)
                hspmd_out = hspmd.kl_div(trans_hspmd_in, hspmd.from_numpy(trans_labels_np))
                hspmd_loss = hspmd_out.sum()
                hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.5)
                torch_loss.backward()
                torch_optimizer.step()
    ...
    def test_mseloss_op(self):
        ...
        for shape in TestLossOps._test_binary_label_shapes:
            ...
            loss = hspmd.mse_loss(trans_probs, trans_labels)
            self.assertTrue(allclose(loss, gt))
            ...
            if GRAD_TEST:
                ...
                hspmd_in = hspmd.Tensor(probs_np, requires_grad=True)
                trans_hspmd_in = hspmd_in.transpose(perm)
                hspmd_out = hspmd.mse_loss(trans_hspmd_in, hspmd.from_numpy(trans_labels_np))
                hspmd_loss = hspmd_out.sum()
                hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.01)
                torch_loss.backward()
                torch_optimizer.step()
...
class TestOtherOps(unittest.TestCase):
    ...
    def test_gatherop(self):
        ...
        for shape_x, shape_id, dim in TestOtherOps._gather_test_shapes:
            ...
            self.assertTrue(allclose(hspmd.gather(trans_x, dim, id), gt))
            ...
            if GRAD_TEST:
                ...
                hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
                trans_hspmd_in = hspmd_in.transpose(perm)
                hspmd_out = hspmd.gather(trans_hspmd_in, dim, id)
                hspmd_loss = hspmd_out.sum()
                hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.01)
                torch_loss.backward()
                torch_optimizer.step()
    ...
    def test_maskedfillop(self):
        ...
        for shape_x in TestOtherOps._maskedfill_test_shapes:
            ...
            self.assertTrue(allclose(hspmd.masked_fill(trans_x, trans_mask, val), gt))
    ...
    def test_normop(self):
        ...
        for shape_x, dim0, p0 in TestOtherOps._norm_test_shapes:
            ...
            self.assertTrue(allclose(hspmd.norm(trans_x, p0, dim0), gt))
            ...
            if GRAD_TEST:
                ...
                hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
                trans_hspmd_in = hspmd_in.transpose(perm)
                hspmd_out = hspmd.norm(trans_hspmd_in, p0, dim0)
                hspmd_loss = hspmd_out.sum()
                hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.01)
                torch_loss.backward()
                torch_optimizer.step()
    ...
    def test_repeatop(self):
        ...
        for shape_x, repeats in TestOtherOps._repeat_test_shapes:
            ...
            self.assertTrue(allclose(hspmd.repeat(trans_x, list(repeats)), gt))
            ...
            if GRAD_TEST:
                ...
                hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
                trans_hspmd_in = hspmd_in.transpose(perm)
                hspmd_out = hspmd.repeat(trans_hspmd_in, list(repeats))
                hspmd_loss = hspmd_out.sum()
                hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.01)
                torch_loss.backward()
                torch_optimizer.step()
    ...
    def test_rollop(self):
        ...
        for shape_x, shifts, dims in TestOtherOps._roll_test_shapes:
            ...
            self.assertTrue(allclose(hspmd.roll(trans_x, list(shifts), list(dims)), gt))
            ...
            if GRAD_TEST:
                ...
                hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
                trans_hspmd_in = hspmd_in.transpose(perm)
                hspmd_out = hspmd.roll(trans_hspmd_in, list(shifts), list(dims))
                hspmd_loss = hspmd_out.sum()
                hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.01)
                torch_loss.backward()
                torch_optimizer.step()
    ...
    def test_embedding_lookupop(self):
        ...
        for shape_x, shape_id in TestOtherOps._embedding_test_shapes:
            ...
            self.assertTrue(allclose(hspmd.embedding_lookup(trans_x, id), gt))
            ...
            if GRAD_TEST:
                ...
                hspmd_in = hspmd.Tensor(x_np, requires_grad=True)
                trans_hspmd_in = hspmd_in.transpose(perm)
                hspmd_out = hspmd.embedding_lookup(trans_hspmd_in, id)
                hspmd_loss = hspmd_out.sum()
                hspmd_optimizer = hspmd.SGDOptimizer([hspmd_in], lr = 0.01)
                torch_loss.backward()
                torch_optimizer.step()
    ...
    def test_onehotop(self):
        ...
        for shape_x in TestOtherOps._onehot_test_shapes:
            ...
            self.assertTrue(allclose(hspmd.onehot(trans_x, 16), gt))
    ...
    def test_whereop(self):
        ...
        for shape_x in TestOtherOps._onehot_test_shapes:
            ...
            self.assertTrue(allclose(hspmd.where(cond, trans_x, trans_y), gt))
        print(sys._getframe().f_code.co_name)
