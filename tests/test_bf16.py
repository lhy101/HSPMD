...
#             x = x.to(hspmd.bfloat16)
#             y = hspmd.from_numpy(y_np)
#             y = y.to(hspmd.bfloat16)
#             c = np.random.randn()
...
#             x = hspmd.from_numpy(x_np).to(hspmd.bfloat16)
#             y = hspmd.from_numpy(y_np).to(hspmd.bfloat16)
#             z = hspmd.from_numpy(z_np).to(hspmd.bfloat16)
#             gt = x_np + y_np + z_np
...
#                 f = hspmd.from_numpy(f_np).to(hspmd.bfloat16)
...
#                 bias = hspmd.from_numpy(bias_np).to(hspmd.bfloat16)
...
#                 scale = hspmd.from_numpy(scale_np).to(hspmd.bfloat16)
