import hspmd as ht
from hspmd.layers import Embedding
import numpy as np
...
class DeepHashEmbedding(Embedding):
    ...
    def make_layers(self, initializer):
        from hspmd.layers.linear import Linear
        from hspmd.layers.normalization import BatchNorm
        from hspmd.layers.mish import Mish
        from hspmd.layers.sequence import Sequence
        layers = [
