...
from hspmd.ndarray import empty
from hspmd.random import get_np_rand
from hspmd.optimizer import SGDOptimizer
from hspmd.random import get_seed_status
import numpy as np
...
class OptEmbedSuperNetTrainer(EmbeddingTrainer):
    ...
    def get_eval_nodes(self):
        from hspmd.gpu_ops import mul_byconst_op, reduce_sum_op, exp_op, opposite_op, add_op
    ...
    def calc_row_sparsity(self, embedding_table, threshold, stream):
        from hspmd.gpu_links import binary_step_forward, array_set, concatenate, reduce_norm1, matrix_elementwise_minus, reduce_sum
        stream.sync()
