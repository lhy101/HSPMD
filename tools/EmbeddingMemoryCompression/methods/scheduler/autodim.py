...
from hspmd.gpu_links import all_fro_norm, matrix_elementwise_divide_const, \
...
class AutoDimTrainer(EmbeddingTrainer):
    ...
    def get_eval_nodes(self):
        from hspmd.gpu_ops.AssignWithIndexedSlices import AssignWithIndexedSlicesOp
        from hspmd.gpu_ops import gradients
