...
class AutoSrhTrainer(SwitchInferenceTrainer):
    ...
    def get_eval_nodes(self):
        from hspmd.gpu_ops import add_op, reduce_sum_op, mul_byconst_op, abs_op, param_clip_op
        from hspmd.gpu_ops import div_op, broadcastto_op, reduce_mean_op, addbyconst_op
