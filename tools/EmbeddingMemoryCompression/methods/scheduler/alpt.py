...
from hspmd.gpu_links import reorder_into_lookup, assign_alpt_embedding
import math
...
class ALPTEmbTrainer(EmbeddingTrainer):
    ...
    def get_eval_nodes(self):
        from hspmd.gpu_ops.AssignWithIndexedSlices import AssignWithIndexedSlicesOp, assign_with_indexedslices_op
        from hspmd.gpu_ops.QuantizeALPTEmb import alpt_rounding_op
        from hspmd.gpu_ops.Division import div_op
        from hspmd.gpu_ops.Broadcast import broadcastto_op
        from hspmd.gpu_ops.EmbeddingLookUp import embedding_lookup_op
        from hspmd.gpu_ops.MultiplyConst import mul_byconst_op
        from hspmd.gpu_ops.executor import gradients
        from hspmd.initializers import GenEmpty
