...
class DeviceGroupUnion {
 public:
  ...
  static inline DeviceGroupUnion device_group_to_union(const DeviceGroup& dg, const hspmd::graph::DistributedStates& ds, int32_t hetero_dim, int32_t num) {
  ...
  // Currently unused
  /*
  static inline DeviceGroup union_to_device_group(const DeviceGroupUnion& dg_union, const hspmd::graph::DistributedStates& ds) {
