...
void RMSNormOpImpl::DoCompute(Operator& op, 
  ...
  HT_DISPATCH_KERNEL_CUDA_ONLY(op->instantiation_ctx().placement.type(), type(), hspmd::impl::DropoutAddLnFwd,
...
void RMSNormGradientOpImpl::DoCompute(Operator& op,const NDArrayList& inputs,
  ...
  HT_DISPATCH_KERNEL_CUDA_ONLY(op->instantiation_ctx().placement.type(), type(),
                               hspmd::impl::DropoutAddLnBwd, dzmat, dxmat, xmat, x0mat, dmask_, mu,
...
void FusedRMSNormGradientOpImpl::DoCompute(Operator& op,const NDArrayList& inputs,
  ...
  HT_DISPATCH_KERNEL_CUDA_ONLY(
    op->instantiation_ctx().placement.type(), type(), hspmd::impl::FusedRMSNormGradient, inputs.at(0),
