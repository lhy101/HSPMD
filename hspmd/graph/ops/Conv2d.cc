...
void Conv2dGradientofFilterOpImpl::DoCompute(Operator& op,
  ...
  HT_DISPATCH_KERNEL_CPU_AND_CUDA(
    op->instantiation_ctx().placement.type(), type(), hspmd::impl::Conv2dGradientofFilter,
...
void Conv2dGradientofDataOpImpl::DoCompute(Operator& op,
                                           ...
                                           RuntimeContext& ctx) const {
  HT_DISPATCH_KERNEL_CPU_AND_CUDA(
    op->instantiation_ctx().placement.type(), type(), hspmd::impl::Conv2dGradientofData, inputs.at(0),
...
void Conv2dAddBiasOpImpl::DoCompute(Operator& op,
  ...
  HT_DISPATCH_KERNEL_CPU_AND_CUDA(
    op->instantiation_ctx().placement.type(), type(), hspmd::impl::Conv2dAddBias, inputs.at(0),
