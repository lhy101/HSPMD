...
void PadOpImpl::DoCompute(Operator& op, 
  ...
  // HT_DISPATCH_KERNEL_CPU_AND_CUDA(op->instantiation_ctx().placement.type(), type(), hspmd::impl::Pad,
...
void PadGradientOpImpl::DoCompute(Operator& op,const NDArrayList& inputs,
  ...
  HT_DISPATCH_KERNEL_CPU_AND_CUDA(
    op->instantiation_ctx().placement.type(), type(), hspmd::impl::PadGradient, inputs.at(0),
