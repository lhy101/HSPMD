...
void LayerNormGradientOpImpl::DoCompute(Operator& op,const NDArrayList& inputs,
  ...
  HT_DISPATCH_KERNEL_CPU_AND_CUDA(
    op->instantiation_ctx().placement.type(), type(), hspmd::impl::LayerNormGradient, inputs.at(0),
...
void FusedLayerNormGradientOpImpl::DoCompute(Operator& op,const NDArrayList& inputs,
  ...
  HT_DISPATCH_KERNEL_CUDA_ONLY(
    op->instantiation_ctx().placement.type(), type(), hspmd::impl::FusedLayerNormGradient, inputs.at(0),
