...
// #include "hspmd/impl/kernel/Unary.cuh"
...
//   NDArray input_output_idx_arr = hspmd::cuda::to_int64_ndarray(fusedgroup.input_output_idx,
//                                                               cuda_stream.device_id());
//   NDArray num_input_output_arr = hspmd::cuda::to_int64_ndarray(fusedgroup.num_input_output,
//                                                               cuda_stream.device_id());
//   NDArray param_arr = hspmd::cuda::to_byte_ndarray((const uint8_t*)fusedgroup.param_info.data(), 
...
//       }
//       NDArray inputs_arr = hspmd::cuda::to_byte_ndarray((const uint8_t*)input_ptrs.data(), 
//                                                        input_ptrs.size() * sizeof(spec_t*), 
//                                                        cuda_stream.device_id());
//       NDArray outputs_arr = hspmd::cuda::to_byte_ndarray((const uint8_t*)output_ptrs.data(), 
