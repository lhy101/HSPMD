...
struct u_pow : unary_cu<spec_t>{
  ...
  __forceinline__ __host__ __device__ 
  spec_t operator() (spec_t input_) {
    return hspmd::cuda::cuda_pow(input_, value_);
  }
  __forceinline__ __host__ __device__ 
  spec_t compute(spec_t input_) {
    return hspmd::cuda::cuda_pow(input_, value_);
...
struct u_exp : unary_cu<spec_t>{
  __forceinline__ __host__ __device__ 
  spec_t operator() (spec_t input_) {
    return hspmd::cuda::cuda_exp(input_);
  }
  __forceinline__ __host__ __device__ 
  spec_t compute(spec_t input_) {
    return hspmd::cuda::cuda_exp(input_);
...
struct u_log : unary_cu<spec_t>{
  __forceinline__ __host__ __device__ 
  spec_t operator() (spec_t input_) {
    return hspmd::cuda::cuda_log(input_);
  }
  __forceinline__ __host__ __device__ 
  spec_t compute(spec_t input_) {
    return hspmd::cuda::cuda_log(input_);
...
struct u_sqrt : unary_cu<spec_t>{
  __forceinline__ __host__ __device__ 
  spec_t operator() (spec_t input_) {
    return hspmd::cuda::cuda_sqrt(input_);
  }
  __forceinline__ __host__ __device__ 
  spec_t compute(spec_t input_) {
    return hspmd::cuda::cuda_sqrt(input_);
...
struct u_abs : unary_cu<spec_t>{
  __forceinline__ __host__ __device__ 
  spec_t operator() (spec_t input_) {
    return hspmd::cuda::cuda_abs(input_);
  }
  __forceinline__ __host__ __device__ 
  spec_t compute(spec_t input_) {
    return hspmd::cuda::cuda_abs(input_);
...
struct u_gelu : unary_cu<spec_t>{
  __forceinline__ __host__ __device__ 
  spec_t operator() (spec_t input_) {
    return input_ * 0.5 * (1.0 + hspmd::cuda::cuda_tanh(0.79788456 * input_ * (1 + 0.044715 * input_ * input_)));
  }
  __forceinline__ __host__ __device__ 
  spec_t compute(spec_t input_) {
    return input_ * 0.5 * (1.0 + hspmd::cuda::cuda_tanh(0.79788456 * input_ * (1 + 0.044715 * input_ * input_)));
