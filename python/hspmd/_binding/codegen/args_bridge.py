...
class ArgType:
    ...
    DATA_TYPE = 10; DATA_TYPE_STR = ("hspmd.dtype", "dtype", "DataType")
    DEVICE = 11; DEVICE_STR = ("hspmd.device", "device", "Device")
    DEVICE_GROUP = 12; DEVICE_GROUP_STR = ("hspmd.DeviceGroup", "DeviceGroup")
    DG_HIERARCHY = 13; DG_HIERARCHY_STR = ("hspmd.DeviceGroupHierarchy", "DeviceGroupHierarchy", "List[hspmd.DeviceGroupList]", "List[DeviceGroupList]", "List[List[hspmd.DeviceGroup]]", "List[List[DeviceGroup]]")
    STREAM = 14; STREAM_STR = ("hspmd.stream", "stream", "Stream")
    ND_ARRAY = 15; ND_ARRAY_STR = ("hspmd.NDArray", "NDArray", "hspmd.ndarray", "ndarray")
    ND_ARRAY_LIST = 16; ND_ARRAY_LIST_STR = ("List[hspmd.NDArray]", "List[NDArray]", "List[hspmd.ndarray]", "List[ndarray]", "NDArrayList")
    TENSOR = 17; TENSOR_STR = ("hspmd.Tensor", "Tensor", "hspmd.tensor", "tensor")
    TENSOR_LIST = 18; TENSOR_LIST_STR = ("List[hspmd.Tensor]", "List[Tensor]", "List[hspmd.tensor]", "List[tensor]", "TensorList")
    OPERATOR = 19; OPERATOR_STR = ("hspmd.Operator", "Operator", "hspmd.operator", "operator")
    OPERATOR_LIST = 20; OPERATOR_LIST_STR = ("List[hspmd.Operator]", "List[Operator]", "List[hspmd.operator]", "List[operator]", "OperatorList", "OpList")
    FEED_DICT = 21; FEED_DICT_STR = ("FeedDict", "feed_dict")
    DISTRIBUTED_STATES = 22; DISTRIBUTED_STATES_STR = ("hspmd.DistributedStates", "DistributedStates")
    DISTRIBUTED_STATES_LIST = 23; DISTRIBUTED_STATES_LIST_STR = ("List[hspmd.DistributedStates]", "List[DistributedStates]", "DistributedStatesList") 
    DS_HIERARCHY = 24; DS_HIERARCHY_STR = ("List[hspmd.DistributedStatesUnion]", "List[DistributedStatesUnion]", "DistributedStatesHierarchy") 
    INT_SYMBOL = 25; INT_SYMBOL_STR = ("hspmd.IntSymbol", "IntSymbol")
    SYMBOLIC_SHAPE = 26; SYMBOLIC_SHAPE_STR = ("List[hspmd.IntSymbol]", "List[IntSymbol]", "SyShape")
    SYMBOLIC_SHAPE_LIST = 27; SYMBOLIC_SHAPE_LIST_STR = ("List[List[[hspmd.IntSymbol]]", "List[List[IntSymbol]]", "List[SyShape]")
    INITIALIZER = 28; INITIALIZER_STR = ("hspmd.Initializer", "Initializer")
