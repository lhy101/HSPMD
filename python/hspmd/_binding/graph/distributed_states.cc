...
PyTypeObject PyDistributedStates_Type_obj = {
  ...
  "hspmd.DistributedStates", /* tp_name */
...
PyTypeObject PyDistributedStatesUnion_Type_obj = {
  PyVarObject_HEAD_INIT(nullptr, 0) 
  "hspmd.DistributedStatesUnion", /* tp_name */
...
std::vector<PyMethodDef> InitDistributedStatesPyClassMethodDefs() {
  ...
  AddPyMethodDefs(ret, hspmd::graph::get_registered_tensor_class_methods()); // TODO: register distributed states class methods
  return ret;
}
