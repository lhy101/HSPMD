...
class MaxPool2d(MaxPoolNd):
    ...
    def forward(self, input: Tensor) -> Tensor:
        return hspmd.maxpool(input, self.kernel_size[0], self.kernel_size[1], self.padding[0], self.stride[0])
...
class AvgPool2d(AvgPoolNd):
    ...
    def forward(self, input: Tensor) -> Tensor:
        return hspmd.avgpool(input, self.kernel_size[0], self.kernel_size[1], self.padding[0], self.stride[0])