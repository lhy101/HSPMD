...
class Bucket:
    ...
    def generate_cp_pack_data(self, cp_size, cp_lens_rate=None):
        ...
        # 目前只写了SYM情形下的packing
        split_pattern = os.environ.get('HSPMD_PARALLEL_ATTN_SPLIT_PATTERN')
        assert split_pattern == "SYM", f"Unsupported HSPMD_PARALLEL_ATTN_SPLIT_PATTERN value: {split_pattern}. Only 'SYM' is supported when using CP + packing."
