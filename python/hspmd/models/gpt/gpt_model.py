...
class GPTBlock(hspmd.nn.Module):
    ...
    def forward(
        ...
        hidden_states = hspmd.comm(hidden_states, self.attn.qkv_dense.ds_union_map['split0_dup'], self.ln_1.device_group_unions, name=f"pipeline_layer_{self.layer_idx}")
