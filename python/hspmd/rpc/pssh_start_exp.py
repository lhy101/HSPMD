...
# from hspmdrpc_polling_server import server_launch
from hspmdrpc_async_server_exp import server_launch
...
def pssh(args):
    ...
    for i, hostname in enumerate(hostnames):
        ...
        cmd_list.append(cmd + f"export HSPMD_LOCAL_HOSTNAME={hostname} && " + train_command + f" 2>&1 | tee {log_path}")
    clients = []
    outputs = []
