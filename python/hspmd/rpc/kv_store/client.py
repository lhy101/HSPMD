...
import json
import sys
from hspmd.rpc import hspmdrpc_pb2_grpc
from hspmd.rpc import hspmdrpc_pb2
from .const import *
...
class RemoteDict:
    ...
    def put(self, key, value):
        ...
        self.client.stub.PutJson(hspmdrpc_pb2.PutJsonRequest(key=full_key, value=value))

    def get(self, key):
        full_key = f'{self.dict_name}{DELIMITER}{key}'
        response = self.client.stub.GetJson(hspmdrpc_pb2.GetJsonRequest(key=full_key))
    ...
    def remove(self, key):
        full_key = f'{self.dict_name}{DELIMITER}{key}'
        response = self.client.stub.RemoveJson(hspmdrpc_pb2.RemoveJsonRequest(key=full_key))
...
class KeyValueStoreClient:
    def __init__(self, address='localhost:50051'):
        ...
        self.stub = hspmdrpc_pb2_grpc.DeviceControllerStub(self.channel)
