...
class DeviceController(hspmdrpc_pb2_grpc.DeviceControllerServicer):
    ...
    def Connect(self, request, context):
        ...
        self.worldsize += 1
        self.lock.release()
        return hspmdrpc_pb2.ConnectReply(status=1)
    ...
    def GetRank(self, request, context):
        ...
        self.arr[0] += 1
        self.lock.release()
        return hspmdrpc_pb2.RankReply(rank=local_rank)
    ...
    def CommitHostName(self, request, context):
        ...
        self.lock.release()
        return hspmdrpc_pb2.CommitHostNameReply(status=1)
    ...
    def GetHostName(self, request, context):
        ...
        self.lock.release()
        return hspmdrpc_pb2.GetHostNameReply(hostname=hostname)
    ...
    def CommitDeviceInfo(self, request, context):
        ...
        self.lock.release()
        return hspmdrpc_pb2.CommitDeviceInfoReply(status=1)
    ...
    def GetDeviceInfo(self, request, context):
        ...
        self.lock.release()
        return hspmdrpc_pb2.GetDeviceInfoReply(type=mtype, index=mindex, multiplex=mmultiplex)
    ...
    def CommitNcclId(self, request, context):
        ...
        self.lock.release()
        return hspmdrpc_pb2.CommitNcclIdReply(status=1)
    ...
    def GetNcclId(self, request, context):
        ...
        self.lock.release()
        return hspmdrpc_pb2.GetNcclIdReply(nccl_id=nccl_id)
    ...
    def Exit(self, request, context):
        ...
        #     time.sleep(0.0001)
        # self.exit_arr[request.rank] = 1
        return hspmdrpc_pb2.ExitReply(status=1)
    ...
    def PutDouble(self, request, context):
        ...
        return hspmdrpc_pb2.PutDoubleReply(status=1)
    ...
    def GetDouble(self, request, context):
        ...
        return hspmdrpc_pb2.GetDoubleReply(value=value)
    ...
    def RemoveDouble(self, request, context):
        ...
        if unfound_times == MAX_UNFOUND_TIMES:
            return hspmdrpc_pb2.RemoveDoubleReply(message="not found:" + request.key)
        else:
            self.double_dict.pop(request.key)
        return hspmdrpc_pb2.RemoveDoubleReply(message="already remove:" + request.key)
    
    def PutInt(self, request, context):
        self.int_lock.acquire()
        self.int_dict[request.key] = request.value
        self.int_lock.release()
        return hspmdrpc_pb2.PutIntReply(status=1)
    ...
    def GetInt(self, request, context):
        ...
        self.double_lock.release()
        return hspmdrpc_pb2.GetIntReply(value=value)
    ...
    def RemoveInt(self, request, context):
        ...
        while(request.key not in self.int_dict and unfound_times < MAX_UNFOUND_TIMES):
            ...
            unfound_times += 1
        if unfound_times == MAX_UNFOUND_TIMES:
            return hspmdrpc_pb2.RemoveIntReply(message="not found:" + request.key)
        else:
            self.int_dict.pop(request.key)
        return hspmdrpc_pb2.RemoveIntReply(message="already remove:" + request.key)
    ...
    def PutString(self, request, context):
        ...
        return hspmdrpc_pb2.PutStringReply(status=1)
    ...
    def GetString(self, request, context):
        ...
        self.string_lock.release()
        return hspmdrpc_pb2.GetStringReply(value=value)
    ...
    def RemoveString(self, request, context):
        ...
        while(request.key not in self.string_dict and unfound_times < MAX_UNFOUND_TIMES):
            ...
            unfound_times += 1
        if unfound_times == MAX_UNFOUND_TIMES:
            return hspmdrpc_pb2.RemoveStringReply(message="not found:" + request.key)
        else:
            self.string_dict.pop(request.key)
        return hspmdrpc_pb2.RemoveStringReply(message="already remove:" + request.key)
    
    def PutBytes(self, request, context):
        self.bytes_lock.acquire()
        self.bytes_dict[request.key] = request.value
        self.bytes_lock.release()
        return hspmdrpc_pb2.PutBytesReply(status=1)
    ...
    def GetBytes(self, request, context):
        ...
        self.bytes_lock.release()
        return hspmdrpc_pb2.GetBytesReply(value=value)
    ...
    def RemoveBytes(self, request, context):
        ...
        while(request.key not in self.bytes_dict and unfound_times < MAX_UNFOUND_TIMES):
            ...
            unfound_times += 1
        if unfound_times == MAX_UNFOUND_TIMES:
            return hspmdrpc_pb2.RemoveBytesReply(message="not found:" + request.key)
        else:
            self.bytes_dict.pop(request.key)
        return hspmdrpc_pb2.RemoveBytesReply(message="already remove:" + request.key)
    ...
    def PutJson(self, request, context):
        ...
        return hspmdrpc_pb2.PutJsonReply(status=1)
    ...
    def GetJson(self, request, context):
        ...
        self.json_lock.release()
        return hspmdrpc_pb2.GetJsonReply(value=value)
    ...
    def RemoveJson(self, request, context):
        ...
        while(request.key not in self.json_dict and unfound_times < MAX_UNFOUND_TIMES):
            ...
            unfound_times += 1
        if unfound_times == MAX_UNFOUND_TIMES:
            return hspmdrpc_pb2.RemoveJsonReply(message="not found:" + request.key)
        else:
            self.json_dict.pop(request.key)
        return hspmdrpc_pb2.RemoveJsonReply(message="already remove:" + request.key)
    ...
    def Barrier(self, request, context):
        ...
        return hspmdrpc_pb2.BarrierReply(status=1)
    
    def HeartBeat(self, request, context):
        self.lock.acquire()
        self.last_heartbeat[request.rank] = time.time()
        self.lock.release()
        return hspmdrpc_pb2.HeartBeatReply(status=1)

def serve(arr, exit_arr, last_heartbeat, port):
    server = grpc.server(futures.ThreadPoolExecutor(max_workers=32))
    hspmdrpc_pb2_grpc.add_DeviceControllerServicer_to_server(DeviceController(arr, exit_arr, last_heartbeat), server)
