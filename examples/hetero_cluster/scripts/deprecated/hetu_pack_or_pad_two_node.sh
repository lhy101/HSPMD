...
export HSPMD_SWITCH_PROFILE=NVLINK
...
-x NCCL_DEBUG \
-x HSPMD_SWITCH_ALGORITHM -x HSPMD_SWITCH_PROFILE -x HSPMD_INTERNAL_LOG_LEVEL -x NCCL_IB_GID_INDEX=3 \
--output-filename logs/ds_parallel --merge-stderr-to-stdout \
python3 hspmd_pack_or_pad.py \
--num_strategy=1 \
