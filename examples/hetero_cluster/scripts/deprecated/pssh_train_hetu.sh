...
CMDM="HSPMD_INTERNAL_LOG_LEVEL=WARN python3 train_hspmd_gpt_ds_parallel.py \
...
python ../../python/hspmd/rpc/pssh_start.py --command "$CMDM" --server_port ${SERVER_PORT} --ngpus ${NUM_GPUS}