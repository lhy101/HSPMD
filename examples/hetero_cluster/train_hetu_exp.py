...
from hspmd.utils.parallel import config2ds
...
def kill_command():
    # 定义包含所有主机的文件
    hosts_file = '/home/pkuhspmd/lhy/multi_switch/examples/nlp/gpt/scripts/host.txt'
    # 定义要查找并杀掉的进程的关键字
    process_keyword = 'python3 -u train_hspmd_train.py'
    # 使用 pssh 执行远程命令
