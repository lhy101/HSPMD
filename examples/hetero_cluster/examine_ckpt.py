...
origin = torch.load('checkpoint/HuggingFace/hspmd_pytorch_model.bin')
x_1 = torch.load('checkpoint/temp/hspmd_pytorch_model-1-of-2.bin')
x_2 = torch.load('checkpoint/temp/hspmd_pytorch_model-2-of-2.bin')
