...
from hspmd.utils.parallel import distributed_init, read_strategy, read_ds_parallel_config, parse_multi_ds_parallel_config
        ...
        for step in range(steps):
            ...
            if args.torch_profile != 0 and step == 1:
                with profile(activities=[ProfilerActivity.CUDA]) as prof:
                    results = hspmd_train(feed_dict, num_micro_batches, strategy_id)
...
if __name__ == '__main__':
    print("Run hspmd single switch training")
